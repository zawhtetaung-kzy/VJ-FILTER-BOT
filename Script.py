...
ကျွန်တော်က နောက်ဆုံးပေါ် အဆင့်မြင့်ပြီး အာနိသင် အင်အားကြီးသော Auto Filter Bot ပါ။
သင့် Group မှာ အသုံးပြုပြီး အကန့်အသတ်မရှိသော ပိုက်ဆံ ဝင်စေနိုင်ပါတယ်...💸</b>"""

    CLONE_START_TXT = """<b><blockquote>ʜᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a></blockquote>
    
ကျွန်တော်က အဆင့်မြင့်ပြီး အင်အားကြီးသော Auto Filter Bot ဖြစ်ပါတယ်၊ အံ့ဩစရာကောင်းတဲ့ Features တွေနဲ့ပါ။
ဘာလိုချင်တယ်ဆိုတာ စာရိုက်လိုက်တာနဲ့ ကျွန်တော့် အင်အားကို မြင်တွေ့ရပါမယ် 💘</b>"""
...
╚═ ██╔══╝██╔════╝██╔════╝██║  ██║     ║██      ██║        ██║
   ...
   ╚═╝    ╚══════╝╚══════╝╚═╝  ╚═╝        ╚════╝   ╚════════╝"""
    ...
    TAMIL_INFO = """
ဟေ့ <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


အခုတော့ Telegram မှာတောင် ငွေရှာနိုင်ပါပြီ။

Telegram ကနေ ငွေရှာဖို့ အဖွဲ့ (Group) တစ်ခု သင့်မှာ ရှိရမယ်။
သင့်မှာ Group ရှိပြီးသားဆိုရင်၊ သင့် Group ထဲကို ကျွန်တော်တို့ Bot ကို ထည့်သွင်းပြီး ငွေရှာနိုင်မယ်။

သင့် Group ထဲမှာ အဖွဲ့ဝင်များ များလေလေ၊ သင့် ဝင်ငွေ ပိုများလာမယ်။

ဘယ်လိုလုပ်ရမလဲ ➝

အဆင့် ၁: TKS Family Movie Sending-BOT ကို သင့် Group ရဲ့ Admin အဖြစ် သတ်မှတ်ပါ။
အဆင့် ၂: သင့် Website နဲ့ API ကို ထည့်သွင်းပါ။

ဥပမာ: /shortlink xtz.in 4b392f8eb6ad711fbe58

Video တစ်ခု ထည့်သွင်းပါ။

👇 ဘယ်လိုထည့်မလဲ 👇

ဥပမာ: /set_tutorial video link

ဒါပြီးရင် သင့် Group ထဲမှာ သင်တန်း Video တင်ပေါ်လာမယ်…"""
